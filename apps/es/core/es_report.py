...
from core.utils.model_utils import redcordsets2List
from core.utils.spreadsheet import SpreadsheetWriter

from ..models import (CashAdvancement, Expense, ExpenseDetail, Office,
                      PaymentMethod, PriorBalance)
from . import acl, es_file
...
def generate_rpt(operator: User, template_file: Path, sch_items: dict) -> Path:
    ...
    Args:
        ...
        template_file (:obj:'pathlib.Path'): Report template file. E.g. resource/templates/ES101/ES101-v1.xlsx
        sch_items (dict): Office code and date range.

    Returns:
        obj:'pathlib.Path': Export file. E.g. tmp/ES/es101-rpt1/HK-20230527123024.xls
    ...
    exportFolder = es_file.getTempFolder('es101-rpt1')
