...
export function SitePlan(props) {
  ...
  return (
    <div>
      ...
      <div hidden={!showSoilDataComponent || !props.editable}>
        <GetSoilData screenID={props.screenID} ptArray={lineArray} colorLayerSets={myLayerColorSets} showSoilData={showSoilData}/>
      </div>
