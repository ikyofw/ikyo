...
(0, 'AppMnt', 'App Management', 'AppMnt', (select id from ik_menu where menu_caption='System'), true, 40, null, null, null),
...
(0, 'Office', 'Office', 'Office', (select id from ik_menu where menu_caption='System'), true, 70, null, null, null),
(0, 'Currency', 'Currency', 'Currency', (select id from ik_menu where menu_caption='System'), true, 80, null, null, null),
(0, 'Inbox', 'Inbox', 'Inbox', (SELECT id FROM ik_menu WHERE menu_nm = 'system'), true, 90, null, null, null);
